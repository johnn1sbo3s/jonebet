<template>
	<div class="flex flex-col gap-4">
		...
		>
			...
			<i v-if="!invertOrder" class="i-lucide-arrow-down-a-z text-xl text-zinc-400 hover:cursor-pointer" @click="invertCardsOrder"/>
		...
		<div class="flex gap-4">
			...
			<div
				...
				class="w-full h-130 flex items-center justify-center outline-dashed outline-1 outline-zinc-700 p-10 rounded-md"
			>
				<p class="text-center text-zinc-500 text-2xl">
