...
| Path | Scope |
|------|-------|
| `app/` | Nuxt 4 application: pages, components, composables, layouts, plugins, stores, utils |
| `tests/` | Vitest unit tests for Vue components |
| `eslint-rules/` | Custom ESLint rules (2 rules: sibling-separator, no-html-comments) |
